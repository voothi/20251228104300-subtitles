...
In the first version of the release, I need to describe the optimal process found for creating subtitles using [Subtitle Edit](https://github.com/SubtitleEdit) and [Whisper Audio Recorder & Transcriber](https://github.com/voothi/20250228230803-whisper) (modified to work in word-by-word subtitle creation mode).
...
3.  **Recognition**: Recognize the audio track. Use [Subtitle Edit](https://github.com/SubtitleEdit) or [Whisper Audio Recorder & Transcriber](https://github.com/voothi/20250228230803-whisper) with Faster-Whisper (recommended model: `large-v3-turbo`) with launch keys `--threads 8 --one_word 2` into an SRT file. This provides word-by-word subtitles (initial **v1**), the most flexible form for further processing.
