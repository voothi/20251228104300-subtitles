...
In the first version of the release, I need to describe the optimal process found for creating subtitles using [Subtitle Edit](https://github.com/SubtitleEdit) and its own utility (modified to work in word-by-word subtitle creation mode).
