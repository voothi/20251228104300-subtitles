...
7.  **Translation**: Translate subtitles in semi-automatic mode using `aistudio.google.com` / Gemini 2.5 Pro. Carry out the translation in Subtitle Edit via Auto-translate / Auto-translate via Copy-Paste... Select Max block size 5000-10000 on an empty model context. Line separator `@@@`. Save the subtitle file with the `.en` postfix (e.g., `20251227091752-auto-substances-for-ii-325-ru.v2.en.srt` for `20251227091752-auto-substances-for-ii-325-ru.v2.ru.srt`).
8.  **Verification**:
